...
package com.milkmidi.jumper {
	...
	[Embed(source="../../../../fla/application.swf", symbol="swc.Main_mc")]
	public class MainEntry2 extends Sprite {
		// 場景上已存在的元件
		// 顯示分數用的動態文字
		...
		private function onAddedToStageHandler(e:Event):void {
			...
			for ( var i:int = 0 ; i < CLOUD_COUNT ; i++ ) {
				var cloud:MovieClip = new CloudMC;
				cloud.cacheAsBitmap = true;
				cloud.centerX = Math.random() * stage.stageWidth;
