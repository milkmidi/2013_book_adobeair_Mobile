...
set DIST_EXT=apk
set TYPE=apk
set EXTDIR=-extdir extensions\android\
goto start
...
set DIST_EXT=ipa
set TYPE=ipa
set EXTDIR=-extdir extensions\ios
goto start
...
echo.
call adt -package -target %TYPE%%TARGET% %OPTIONS% %SIGNING_OPTIONS% "%OUTPUT%" "%APP_XML%" %FILE_OR_DIR% %EXTDIR%
::-extdir extensions\bin\
echo.
