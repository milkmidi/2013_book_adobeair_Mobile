...
set APP_ID=com.milkmidi.book2013samples

:: 打包後要輸出的資料夾路徑
set DIST_PATH=dist
:: 打包後的安裝檔名
set DIST_NAME=milkmidi_2013bookSamples

:: Debugging using a custom IP
set DEBUG_IP=192.168.1.12

:: 應用程式描述檔 Application descriptor
set APP_XML=application_desktop.xml
...
set AND_CERT_FILE=../source_all/_Android_Certificate/milkmidiAIR.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=../source_all/_iOS_fakeCertificate/mycert.p12
set IOS_DEV_CERT_FILE=../source_all/_iOS_fakeCertificate/mycert.p12
set IOS_DEV_CERT_PASS=pass
set IOS_PROVISION=../source_all/_iOS_fakeCertificate/Fake.mobileprovision
